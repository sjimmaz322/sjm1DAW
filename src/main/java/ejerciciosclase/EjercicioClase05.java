...
public class EjercicioClase05 {
    ...
    public static void main(String[] args) {
        //Ej 1-13 POO
        //EJ 21, 22 y 23 (Apuntes Pág 8, clase Vehículo)
        /*
        
        EJERCICIOS DE INTRODUCCIÓN A LA P.O.O


        ¿Qué es un programa orientado a objetos?
        Una colección de objetos que se crean, se relacionan entre si y de eliminan cuando dejan de ser necesarios
        para diseñar aplicaciones informáticas.
